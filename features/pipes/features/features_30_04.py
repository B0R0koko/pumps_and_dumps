...
def transform_to_features_30(
    ...
    all_features["quote_abs_auc_1d"] = auc_score
    ...
    all_features["quote_abs_auc_12h"] = auc_score
    ...
    all_features["deviation_arctan_time_quote_abs_7d_auc"] = deviation_auc
    ...
    all_features["gini_index_quote_abs_7d"] = gini_index
